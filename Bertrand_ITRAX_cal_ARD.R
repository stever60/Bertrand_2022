...
setwd("/Users/Steve/Dropbox/BAS/Data/R/Papers/Bertrand_2021")
...
library(chemometrics)
ARD_COMP_filter1_text <- select(ARD_COMP_filter1, Core:MSE)
ARD_COMP_filter1_text

ARD_COMP_filter1_clr1 <- select(ARD_COMP_filter1, Fe) %>% 
  clr%>% 
  as_tibble()
...
ARD_Fig16 <- ARD_Ln_Ti_norm.Z_long  %>%
  ...
  geom_vline(xintercept = c(1257, 2552, 2933, 3800, 4163, 4418, 5298, 5874, 6538, 6936), colour = "red", lty = 2, alpha = 0.7)+
  ggtitle("Log Ti-normalised Z-scores (filtered elements): CONISS XRF")
ggarrange(ARD_Fig15, ARD_Fig16, nrow = 2)
ggsave("Figures/ARD/Fig 16_Ti_Z_CONISS_2017_age.pdf",
       height = c(30), width = c(15), dpi = 600, units = "cm")
...
# https://www.dropbox.com/s/a1hs9g0j6tsemlf/YAN_ITRAX_COMP_SH20.csv?dl=0 

# Composite YAN - ITRAX cps data & Sh20 BACON age-depth model (added in Excel)
YAN_x.raw <- read_csv("/Users/Steve/Dropbox/BAS/Data/R/Papers/Bertrand_2021/Data/YAN_ITRAX_COMP_SH20.csv")
YAN_x.raw
...
ggsave("Figures/YAN/Fig 4__cps_inc.pdf",
       height = c(15), width = c(30), dpi = 600, units = "cm")
...
YAN_Fig16 +
  geom_vline(xintercept = c(3369.89, 4836.78, 5520.18, 6058.28, 6876.51, 7024.81, 7550.8), colour = "red", lty = 2, alpha = 0.7)+
  ggtitle("Log Ti-normalised Z-scores (filtered elements): CONISS XRF")
ggarrange(YAN_Fig15, YAN_Fig16, nrow=2)
ggsave("Figures/YAN/Fig 15_16_Ti_Z_CONISS_2017_age.pdf",
       height = c(30), width = c(15), dpi = 600, units = "cm")
